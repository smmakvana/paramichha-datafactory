 ...
 * </pre>
 */
public final class LongFieldBuilder {

    private FieldBuilder<Long> delegate;

    LongFieldBuilder(FieldBuilder<Long> delegate) {
     ...
     */
    public LongFieldBuilder range(long min, long max) {
     ...
     * @param min inclusive minimum
     */
    public LongFieldBuilder min(long min) {
        return with("@Min(" + min + ")");
    }
     ...
     * @param max inclusive maximum
     */
    public LongFieldBuilder max(long max) {
        return with("@Max(" + max + ")");
    }
     ...
     */
    public LongFieldBuilder positive() {
     ...
     */
    public LongFieldBuilder negative() {
     ...
     */
    public LongFieldBuilder with(Class<? extends Annotation> annotation) {
     ...
     */
    public LongFieldBuilder with(String annotation) {
        delegate = delegate.with(annotation);
        return this;
    }
