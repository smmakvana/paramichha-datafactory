 ...
 * </pre>
 */
public final class IntegerFieldBuilder {

    private FieldBuilder<Integer> delegate;

    IntegerFieldBuilder(FieldBuilder<Integer> delegate) {
     ...
     */
    public IntegerFieldBuilder range(int min, int max) {
     ...
     * @param min inclusive minimum
     */
    public IntegerFieldBuilder min(int min) {
        return with("@Min(" + min + ")");
    }
     ...
     * @param max inclusive maximum
     */
    public IntegerFieldBuilder max(int max) {
        return with("@Max(" + max + ")");
    }
     ...
     */
    public IntegerFieldBuilder positive() {
     ...
     */
    public IntegerFieldBuilder negative() {
     ...
     */
    public IntegerFieldBuilder with(Class<? extends Annotation> annotation) {
     ...
     */
    public IntegerFieldBuilder with(String annotation) {
        delegate = delegate.with(annotation);
        return this;
    }
