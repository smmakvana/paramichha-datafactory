 ...
 * </pre>
 */
public final class DecimalFieldBuilder {

    private FieldBuilder<BigDecimal> delegate;
    private int scale = -1;

    DecimalFieldBuilder(FieldBuilder<BigDecimal> delegate) {
     ...
     */
    public DecimalFieldBuilder range(String min, String max) {
     ...
     */
    public DecimalFieldBuilder min(String min) {
        return with("@DecimalMin(value=\"" + min + "\")");
    }
     ...
     */
    public DecimalFieldBuilder max(String max) {
     ...
     */
    public DecimalFieldBuilder positive() {
     ...
     */
    public DecimalFieldBuilder negative() {
     ...
     */
    public DecimalFieldBuilder digits(int integer, int fraction) {
        this.scale = fraction;
     ...
     */
    public DecimalFieldBuilder with(Class<? extends Annotation> annotation) {
     ...
     */
    public DecimalFieldBuilder with(String annotation) {
        delegate = delegate.with(annotation);
        return this;
    }
